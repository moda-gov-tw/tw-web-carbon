      ...
      <div class="container">
        <div class="row g-5">
          <div class="col-lg-5 pt-4">
            ...
            <a href="/gain" :title="urlTitle(props.title)" class="ctca-font ctca-font-size-title">{{ props.title
              }}</a>>
            <a :href="backUrl(props.type)" :title="urlTitle(props.type_desc)" class="ctca-font ctca-font-size-title">{{
              props.type_desc
            }}</a>
          </div>
        </div>
